  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-2">
            <span className="font-display text-sm font-medium text-yellow-400">
              {change.service_name}
            </span>
            <span className="text-zinc-600">•</span>
            <SeverityBadge severity={change.severity} />
          </div>
          <h3 className="font-display text-base font-medium text-white mb-1 group-hover:text-yellow-300 transition-colors truncate">
            {change.title}
          </h3>
      ...
      <div className="mt-4 pt-4 border-t border-white/10 flex items-center justify-between">
        ...
        <span className="label text-yellow-400 opacity-0 group-hover:opacity-100 transition-opacity">
          View →
        </span>
      </div>
    </Link>
