...
export default function ChangeDetailClient({ id: propId }: { id: string }) {
  // In static export, prop may be the placeholder "_"; read real ID from URL
  const pathname = usePathname();
  const id = pathname?.split("/").filter(Boolean).pop() || propId;
